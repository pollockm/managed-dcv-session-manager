...
class Session(object):
    ...
    def __init__(self, id=None, name=None, owner=None, server=None, type=None, max_concurrent_clients=None, state=None, state_reason=None, creation_time=None, last_disconnection_time=None, num_of_connections=None):  # noqa: E501
